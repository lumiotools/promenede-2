...
export default function Opportunities({
  ...
  const displayOpportunities = data.opportunities
    ? data.opportunities.slice(0, 5)
    : [];
  const displayEditOpportunities = editData.opportunities
    ? editData.opportunities.slice(0, 5)
    : [];
      ...
      {isOpportunitiesEmpty ? (
        ...
        <div className="border border-[#ced7db] rounded-sm overflow-hidden">
          ...
          {displayOpportunities.map((opportunity, index) => (
            ...
            >
              {index === 0 ||
              displayOpportunities[index - 1].area !== opportunity.area ? (
