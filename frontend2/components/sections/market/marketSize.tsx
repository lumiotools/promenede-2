...
export default function MarketSizePage({ initialData }: MarketSizePageProps) {
  ...
  const updateYearData = (yearField: YearDataField, field: keyof YearData, value: string | null) => {
    if (!editData) return
  ...
  return (
    <SectionLayout title="Market Size" sourceText={sourceText} showEditButton={false}>
...
interface EditFormProps {
  ...
  updateYearData: (yearField: YearDataField, field: keyof YearData, value: string | null) => void
  updateTrends: (yearField: YearDataField, value: string) => void
}

function EditForm({ data, updateEditData, updateYearData, updateTrends }: EditFormProps) {
  if (!data) return null
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateYearData("pastYearData", "marketSize", e.target.value)}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateYearData("pastYearData", "cagr", e.target.value)}
              ...
              <div className="md:col-span-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => updateYearData("pastYearData", "explanation", e.target.value)}
                  placeholder="Enter market explanation"
                  rows={3}
                />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium mb-1">Key Industry Trends (one per line)</label>
                <Textarea
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium mb-1">Key Excerpt</label>
                <Textarea
                  value={data.pastYearData?.keyExcerpt || ""}
                  onChange={(e) => updateYearData("pastYearData", "keyExcerpt", e.target.value)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateYearData("yearBeforeData", "marketSize", e.target.value)}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateYearData("yearBeforeData", "cagr", e.target.value)}
              ...
              <div className="md:col-span-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => updateYearData("yearBeforeData", "explanation", e.target.value)}
                  placeholder="Enter market explanation"
                  rows={3}
                />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium mb-1">Key Industry Trends (one per line)</label>
                <Textarea
                  value={data.yearBeforeData?.keyIndustryTrends?.join("\n") || ""}
                  onChange={(e) => updateTrends("yearBeforeData", e.target.value)}
                  placeholder="Enter trends, one per line"
                  rows={4}
                />
              </div>
              <div className="md:col-span-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => updateYearData("yearBeforeData", "keyExcerpt", e.target.value)}
                  placeholder="Enter key excerpt"
                  rows={3}
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateYearData("projectionFor2030", "marketSize", e.target.value)}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateYearData("projectionFor2030", "cagr", e.target.value)}
                  placeholder="e.g. 37.9%"
                />
              </div>
              <div className="md:col-span-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => updateYearData("projectionFor2030", "explanation", e.target.value)}
                  placeholder="Enter market explanation"
                  rows={3}
                />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium mb-1">Key Industry Trends (one per line)</label>
                <Textarea
                  value={data.projectionFor2030?.keyIndustryTrends?.join("\n") || ""}
                  onChange={(e) => updateTrends("projectionFor2030", e.target.value)}
                  placeholder="Enter trends, one per line"
                  rows={4}
                />
              </div>
              <div className="md:col-span-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => updateYearData("projectionFor2030", "keyExcerpt", e.target.value)}
                  placeholder="Enter key excerpt"
                  rows={3}
                />
              </div>
...
function MarketSizeTable({ data }: MarketSizeTableProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-[#445963]">Market size estimates for {data.industryName || "Industry"}</CardTitle>
      </CardHeader>
      <CardContent>
            ...
            <tbody>
              {data.pastYearData && (
                <tr className="border-b border-[#ced7db]">
                  <td className="p-3 align-top">
                    <div className="font-medium">{data.industryName || "Industry"} Market (Past Year)</div>
                    {data.pastYearData.marketSize && (
                      <div className="text-sm text-[#57727e] mt-1">Market Size: {data.pastYearData.marketSize}</div>
                    )}
                    {data.pastYearData.cagr && (
                      <div className="text-sm text-[#57727e] mt-1">CAGR: {data.pastYearData.cagr}</div>
                    )}
                  </td>
                  <td className="p-3">
                    {data.pastYearData.keyExcerpt ? (
                      <ul className="list-disc pl-5 space-y-2">
                        ...
                        {data.pastYearData.explanation && <li>{data.pastYearData.explanation}</li>}
                        {data.pastYearData.keyIndustryTrends?.map((trend, index) => (
              ...
              {data.yearBeforeData && (
                <tr className="border-b border-[#ced7db] bg-[#f8f9fa]">
                  <td className="p-3 align-top">
                    <div className="font-medium">{data.industryName || "Industry"} Market (Year Before)</div>
                    {data.yearBeforeData.marketSize && (
                      <div className="text-sm text-[#57727e] mt-1">Market Size: {data.yearBeforeData.marketSize}</div>
                    )}
                    {data.yearBeforeData.cagr && (
                      <div className="text-sm text-[#57727e] mt-1">CAGR: {data.yearBeforeData.cagr}</div>
                    )}
                  </td>
                  <td className="p-3">
                    {data.yearBeforeData.keyExcerpt ? (
                      <ul className="list-disc pl-5 space-y-2">
                        ...
                        {data.yearBeforeData.explanation && <li>{data.yearBeforeData.explanation}</li>}
                        {data.yearBeforeData.keyIndustryTrends?.map((trend, index) => (
                          <li key={index}>{trend}</li>
                        ))}
                      </ul>
                    ) : (
              ...
              {data.projectionFor2030 && (
                <tr>
                  <td className="p-3 align-top">
                    <div className="font-medium">{data.industryName || "Industry"} Market (Projection for 2030)</div>
                    ...
                    {data.projectionFor2030.cagr && (
                      <div className="text-sm text-[#57727e] mt-1">CAGR: {data.projectionFor2030.cagr}</div>
                    )}
                  </td>
                  <td className="p-3">
                    {data.projectionFor2030.keyExcerpt ? (
                      <ul className="list-disc pl-5 space-y-2">
                        ...
                        {data.projectionFor2030.explanation && <li>{data.projectionFor2030.explanation}</li>}
                        {data.projectionFor2030.keyIndustryTrends?.map((trend, index) => (
                          <li key={index}>{trend}</li>
                        ))}
                      </ul>
                    ) : (
        ...
        {!data.pastYearData && !data.yearBeforeData && !data.projectionFor2030 && (
