...
export default function StrategicDevelopmentTimeline({
  initialData,
  ...
  const renderContent = ({ isEditing, editData, setEditData }: any) => {
      ...
      return (
        <div className="text-center py-16 text-gray-500">
          ...
          <p className="text-sm mt-2">
            Edit this section to add strategic development information
          </p>
        </div>
      );
    }
    ...
    const getSortedYears = (): string[] => {
      ...
      return Object.keys(currentData.years).sort(
                    ...
                    <div className="bg-white p-4 border border-gray-200 rounded-lg shadow-sm w-full">
                      ...
                      {currentData?.years?.[year]?.initiativesAndAchievements
                        ...
                        <div className="space-y-4">
                          {currentData.years[
                            year
                          ]?.initiativesAndAchievements?.map(
                            (initiative: Initiative, i: number) => (
                              <div
                                key={i}
