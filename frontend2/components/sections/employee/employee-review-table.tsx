...
export function EmployeeReviewsTable() {
  return (
    <div className="space-y-6 bg-white">
      {/* Header */}
      <h1 className="text-4xl font-medium text-[#475467]">Organization: Employee reviews by topic area</h1>
      ...
      {/* Footer Source */}
      <div className="text-xs text-gray-500 italic mt-6">Source: 1.PromenadeAI, 2.Crunchbase</div>
    </div>
  )
}
