...
export default function EmployeeBreakdown({
  ...
  return (
    <SectionLayout
      title="Break-up of Employees by Function"
      ...
      {({ isEditing, editData, setEditData }) => (
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="lg:w-[70%]">
            <div className="bg-[#f7f9f9] p-4 rounded-lg shadow-sm">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-sm font-medium text-[#445963]">
                  Top Departments
                </h3>
              ...
              <div className="relative h-[300px]">
                ...
                <div className="absolute top-0 right-0 h-full flex flex-col justify-around pr-56">
                  {departmentData.map((entry, index) => (
                    <div
                      key={`value-${index}`}
                      className="text-[#445963] text-xs font-medium"
                    >
              ...
              <div className="mt-2 text-xs text-[#445963]">
                {topDepartments.length >= 3 ? (
                  <>
                    ...
                    {topDepartments[2]?.value ?? 0}) are the three main
                    functions
                  </>
                ) : (
                  "No department data available"
          ...
          <div className="lg:w-[30%] bg-[#f7f9f9] p-4 rounded-lg shadow-sm">
            <h3 className="text-sm font-medium text-[#445963] mb-3">
              Department Summary
            </h3>
            <div className="prose prose-sm max-w-none">
              {initialData?.department_summary ? (
                ...
                <p className="text-xs text-[#445963]">
                  The company has a diverse workforce distributed across various
                  departments. Engineering, Sales, and Marketing form the core
                  of the organization, with significant growth observed in the
                  Technical and Product departments over the past year.
                </p>
              )}
            </div>
          </div>
