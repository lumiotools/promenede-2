  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 bg-white">
      ...
      <div className="bg-gray-50 p-6 rounded-lg">
        <h2 className="text-2xl font-medium text-gray-700 mb-6">M & A Investment Map</h2>
                ...
                <div className="flex items-center justify-center">
                  <div className="h-16 w-16 flex items-center justify-center">
                    <svg viewBox="0 0 100 100" className="h-12 w-12">
                      <path d="M20,80 Q50,20 80,80" stroke="#F97316" strokeWidth="8" fill="none" />
              ...
              {data.map((acquisition, index) => (
                <div key={acquisition.id} className="mb-16 relative">
                  ...
                  <div className="bg-gray-200 p-3 rounded-lg w-64 mb-4">
                    <p className="text-gray-700">{acquisition.category || "Uncategorized"}</p>
                  </div>

                  {/* Horizontal line from left to category */}
                  <div className="absolute left-0 top-6 w-16 h-0.5 bg-gray-400" style={{ left: "-16px" }}></div>
                  ...
                  {/* Company box */}
                  <div className="absolute top-0 flex items-center" style={{ left: "calc(100% + 16px)" }}>
                    <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-200 w-48">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h3 className="text-base font-medium text-gray-700">{acquisition.acquireeName}</h3>
                          <span className="text-sm text-gray-500">{formatYear(acquisition.announcedDate)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div className="mt-6 text-gray-500 text-sm">Source: 1.PromenadeAI, 2.Crunchbase</div>
    </div>
  )
}
