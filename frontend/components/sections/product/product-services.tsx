...
export default function ProductsServices({
  ...
  const [data, setData] = useState<ProductsServicesItem | undefined>(
    initialData
  );
      ...
      <div className="mx-10">
        <div className="border border-[#e5e7eb] rounded-md overflow-hidden">
          <div className="flex items-center justify-between p-4 border-b border-[#e5e7eb]">
            ...
            <button
              className={`${
                editMode.active ? "text-blue-600" : "text-[#8097a2]"
              } hover:text-[#475467] flex items-center gap-1`}
          ...
          {data?.details.map((product, productIndex) => (
            <div key={productIndex} className="flex">
              <div className="w-[240px] bg-[#002169] text-white p-6">
                {editMode.active &&
                editMode.productIndex === productIndex &&
                editMode.field === "categoryName" ? (
                  ...
                  <div className="flex justify-between items-center cursor-pointer">
                    <span
                      onClick={() =>
                        startEditing(productIndex, null, "categoryName")
                      }
                    >
              ...
              <div className="flex-1 p-4">
                <div className="text-[#475467]">
                  <p>{product.description || "No Data Available"}</p>
