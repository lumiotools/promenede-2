...
export function FinancialSummary({ initialData }: FinancialSummaryProps) {
  ...
  const handleSaveClick = () => {
    ...
    const userAttachment = {
      name: "financial-summary-update.tsx",
      url: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/financial-summary-update.tsx",
    };
    ...
    >
      <div className="flex-grow">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-semibold text-[#445963]">
            Financial Summary (Past three years)
          </h2>
      ...
      {/* Footer with source text, always at the bottom */}
      <div className="mt-auto pt-4 text-sm text-[#475467]">{sourceText}</div>
    </div>
  );
}
