...
export default function WebTraffic({ initialData }: WebTrafficTypeProps) {
  ...
  if (!data || !data.visits_by_month || !data.visits_by_country) {
    return (
      <div
        className="space-y-6 bg-white p-6 flex flex-col"
      ...
      >
        <div className="flex-grow">
          ...
          <div className="p-6 text-center text-[#475467]">
    ...
    >
      <div className="flex-grow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div>
            <h3 className="text-[#475467] font-medium mb-4">
              MoM Trend (12 months)
            </h3>
              ...
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <Tooltip
                      formatter={(value) => [`${value}M`, "Traffic"]}
